...
func _on_whip_used(current_timeout):
    $MarginContainer/HBoxContainer/Control/VBoxContainer/Whip.visible = true
    $MarginContainer/HBoxContainer/Control/VBoxContainer/Whip/AnimationPlayer.get_animation("whip").length = current_timeout
    $MarginContainer/HBoxContainer/Control/VBoxContainer/Whip/AnimationPlayer.play("whip")


func _on_aoe_taunt_stun(current_timeout):
